...
export default function Header() {
    ...
    return (
        <header className="">
            <div className={"bg-custom-1 flex flex-col md:flex-row justify-end text-white text-2xl py-3 px-5 md:space-x-2 space-x-0"}>
            ...
            <div className="md:px-8 px-5 py-4 flex items-centers justify-between">
            ...
            <div className={"border-y-2 border-custom-3 py-2"}>
                <div className={"flex flex-row justify-evenly bg-custom-3 text-xl gap-2 py-2 pr-2"}>
                    {navBarCategories.map(item => (
                        <Link key={item.name} href={item.path}>
                            <div className="cursor-pointer hover:shadow-lg py-1 px-3 rounded-lg font-bold">
                                {item.name}
                            </div>
                        </Link>
                    ))}
