                            ...
                            <div className="flex flex-row w-[90%] h-full bg-custom-2 justify-end">
                                <div className="flex flex-row w-[90%] h-full bg-custom-1">
                                    <div className="skew-x-12 flex flex-col justify-evenly py-5">
                                        <div
                                            className="md:pl-10 sm:pl-6 pl-5 md:text-xl text-sm text-white">累積數萬用戶
                                        </div>
                                        <div
                                            className="md:pl-8 sm:pl-5 pl-4 md:text-xl text-sm text-white">免費諮詢貸款
                                        </div>

                                        <div
                                            className="md:pl-4 pl-1 md:text-3xl sm:text-xl text-base font-bold text-white">撐家庭
                                        </div>
                                        <div
                                            className="md:pl-2 pl-0 md:text-3xl sm:text-xl text-base font-bold text-white">度難關
                                        </div>
                                    </div>
                                </div>
                            </div>
